...
if (isset($_GET['id'])) {
    ...
    $query = "DELETE FROM employees WHERE emp_number = $id ";
    mysqli_query($connection, $query);

      // User activity tracker
      $role = $_SESSION['userRole'];
      $activity = "Deleted an Employee. for (Employee No. " . $id. ")";
    ...
    echo 'window.location.href = "viewemployees.php";';
    echo '</script>';
} else {
    // If no employee ID is provided, redirect to the viewStudents page
