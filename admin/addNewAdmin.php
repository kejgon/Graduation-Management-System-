...
<body>
    ...
    <div class="section">
        <div class="row">
            ...
            <div class="right" style="background-color:#FFF;">
                <h3> Add New <?php echo $_SESSION['userRole'];?> </h3>

                <div class="clearance-form">

                    <form action="addNewAdmin.php" method="post" onsubmit="return formValidation();">
                        ...
                        <div class="row">
                            ...
                            <div class="col-90">
                                <label for="fname">Admin number:</label>
                                <input type="text" id="adminNo" name="adminNo" placeholder="Enter your admin number">
  ...
  text-decoration: none;
" href="viewadministrators.php">View the administrators</a>
...
if(isset($_POST['addAdmin'])) {
    ...
    // Check if an admin with the same admin_number already exists in the database
    $sql = "SELECT COUNT(*) as count FROM admin WHERE admin_number = '$adminNo'";
    $result = $connection->query($sql);
    $row = $result->fetch_assoc();

    if ($row["count"] > 0) {
        echo "<p style='color:red'>Sorry: An Admin with the same details already exists.</p>";
    } else {
        // If no admin with the same admin_number exists, proceed to insert the new admin into the database
  ...
  $activity="Added new Administrator.  (Admin No. ".$adminNo.")";
  ...
  mysqli_query($connection, $insert);  
            ...
            echo "<p style='color:blue'>An Admin has been Added successfully</p>";
        } else {
