...
?>
            <div class="right" style="background-color:#FFF;">
                ...
                <div class="clearance-form">
                    ...
                    <form id="hodUpdateStatusForm" action="updateStatus.php" method="POST"
                        onsubmit="return validatinForms();">
...
$activity="Hod updating clearance status for Student No. ".$stdNo;
