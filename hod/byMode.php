    ...
    <div class="section">
        <div class="row">
            ...
            <div class="right" style="background-color:#FFF;">
                <h3>Clearance report by Mode of study</h3>
...
if (isset($_SESSION['theMode'])) {
    $selectedMode = $_SESSION['theMode'];
...
$empRow = mysqli_fetch_array($empResult);
   ...
   // Build the query
   $sql = "SELECT c.clr_id, c.std_fullname, c.std_regNo, c.faculty, c.department, c.levels, c.programs, c.specialization, c.campus,c.mode_of_study, r.stdStatus, r.updated_at 
   FROM clearance c 
   INNER JOIN fin_clearance_request r ON c.clr_id = r.clr_id
   WHERE c.mode_of_study = '$selectedMode'
AND c.department = '{$empRow['department']}'";
