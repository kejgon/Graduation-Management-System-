    ...
    <div class="section">
        <div class="row">
            ...
            <div class="right" style="background-color:#FFF;">
                <h3>HOD Clearance Students Requests</h3>
...
$query = "SELECT DISTINCT hcr.*
          FROM hod_clearance_request hcr
          INNER JOIN students s ON hcr.std_regNo = s.std_regNo
          INNER JOIN employees e ON s.faculty = '{$empRow['faculty']}' AND s.department = '{$empRow['department']}'
          WHERE hcr.std_regNo = s.std_regNo";
