...
?>
            ...
            <div class="right" style="background-color:#FFF;">
                ...
                <div class="clearance-form">
                    ...
                    <form id="deanUpdateStatusForm" action="updateStatus.php" method="POST"
                        onsubmit="return validattionForm();">
...
if(isset($_POST['updateStatus'])) {
    ...
    if (mysqli_num_rows($result) > 0) {
        echo "<p style='color:red;'>Sorry! the student must be cleared by Librarian  first! </p>";
...
$activity="Dean updating clearance status for Student No. ".$stdNo;
