...
?>
            ...
            <div class="right" style="background-color:#FFF;">
                ...
                <div class="clearance-form">
                    ...
                    <form id="regUpdateStatusForm" action="updateStatus.php" onsubmit="return validationFunction();"
                        method="POST">
...
// The query is to check whether the student had been cleared from the previous section
    ...
    if (mysqli_num_rows($result) > 0) {
        echo "<p style='color:red'>Sorry! the student must be cleared by Dean of Students  first! </p>";
...
$activity="Registrar updating clearance status for Student No. ".$stdNo;
...
mysqli_query($connection, $insert);        
                ...
                if ($clRow > 0) {
                    ...
                    if ($row["count"] > 0) {
                        echo "<p style='color:red'>Sorry: you've already submitted your request. You can't submit more than one request.</p>";
                    } else {
                        ...
                        echo "<p style='color:green'>The clearance status was updated successfully, and it had been sent to finance for clearance.</p>";
                    }
