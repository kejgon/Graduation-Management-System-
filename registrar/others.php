    ...
    <div class="section">
        <div class="row">
            ...
            <div class="right" style="background-color:#FFF;">
                ...
                <h3>Approved students for other reasons for clearance list</h3>
                ...
                <table id="myTable" style="color:#000; text-align:left; padding-left:10px;">
                    ...
                    <tbody>
                        <?php
// Build the query
$sql = "SELECT c.clr_id, c.std_fullname, c.std_regNo, c.faculty, c.department, c.levels,c.programs, c.specialization, c.mode_of_study, c.campus, c.reason_for_clearance, c.other_reasons_for_clearance, r.stdStatus, r.updated_at 
FROM clearance c 
INNER JOIN fin_clearance_request r ON c.clr_id = r.clr_id
WHERE c.reason_for_clearance = 'others'";
...
<td>{$row['other_reasons_for_clearance']}</td>
