...
//? Retreiving Clearance details
  ...
  // Query the database to get the path of the file
  $sql = "SELECT transcript FROM students WHERE std_regNo = '{$std_regNo}'";
  $result = mysqli_query($connection, $sql);
  $row = mysqli_fetch_assoc($result);

  // Get the path of the transcript file
  $transcript = $row['transcript'];
  if ($transcript) {
      // If the transcript file exists, set the path to the file
      $transcript_path = "../student/files/".$transcript;
  } else {
      // If the transcript file does not exist, set the path to "#" and provide a message
      $transcript_path = "#";
                    ...
                    <div class="row">
                        <table class="profile-tab">
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if ($transcript_path != "#"): ?>
                                    <a href="<?php echo $transcript_path; ?>" target="_blank">View Transcript</a>
                                    <?php else: ?>
                                    <p><?php echo $transcript_message; ?></p>
                                    <?php endif; ?>
                                </td>
