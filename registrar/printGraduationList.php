...
?>
    <h2 style="text-align: left; margin-top:80px; padding-left:38%;padding-bottom:5%;">CUEA Graduation List</h2>
    <div class="row">
        ...
        <table id="myTable" style="color:#000; text-align:left; padding-left:10px;">
            ...
            <tbody>
                <?php
    // Build the query
    $sql = "SELECT c.clr_id, c.std_fullname, c.std_regNo, c.faculty, c.department, c.levels,c.programs, c.specialization, c.campus 
 FROM clearance c 
 INNER JOIN fin_clearance_request r ON c.clr_id = r.clr_id
 WHERE c.reason_for_clearance = 'completion' ORDER BY c.levels DESC;";
