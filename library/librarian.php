            ...
            <div class="right" style="background-color:#FFF;">
                ...
                <div class="row">
                    ...
                    <div class="box2">
                        ...
                        <?php
                        $sql = "SELECT COUNT(*) FROM library_clearance_request WHERE stdStatus = 'Pending'";
                    ...
                    <div class="box3">
                        ...
                        <?php
                        $sql = "SELECT COUNT(*) FROM library_clearance_request WHERE stdStatus = 'Approved'";
                        $result = mysqli_query($connection, $sql);
                    ...
                    <div class="box4">
                        ...
                        <?php
                        $sql = "SELECT COUNT(*) FROM library_clearance_request WHERE stdStatus = 'Rejected'";
                        $result = mysqli_query($connection, $sql);
