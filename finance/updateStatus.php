...
<body>
    ...
    <div class="section">
        <div class="row">
            ...
            <?php 
    // Store the GET values in the session
...
?>
            ...
            <div class="right" style="background-color:#FFF;">
                ...
                <div class="clearance-form">
                    ...
                    <form id="finUpdateStatusForm" action="updateStatus.php" method="POST"
...
if(isset($_POST['updateStatus'])) {
    ...
    $sql = "SELECT * FROM reg_clearance_request WHERE std_regNo = $stdNo AND (stdStatus ='Pending' OR stdStatus ='Rejected')";
    ...
    if (mysqli_num_rows($result) > 0) {
        echo "<p style='color:red'>Sorry! the student must be cleared by registrar  first! </p> ";

    } else {
        // Retrieving Student details
        $query = "SELECT * FROM fin_clearance_request WHERE std_regNo = $stdNo";
        $result = mysqli_query($connection, $query);
        $row = mysqli_fetch_array($result);

        if ($row > 0) {
            $sql = "UPDATE fin_clearance_request SET stdStatus = '$status', emp_fullname = '$empFullName' WHERE std_regNo = $stdNo";
            if (mysqli_query($connection, $sql)) {

                     ////! User activiy
$role = $_SESSION['position'];
$activity="Finance updating clearance status for Student No. ".$stdNo;
